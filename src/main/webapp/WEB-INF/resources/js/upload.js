...
const checkEmpCode = () =>{
	if (document.getElementById('empCode').value === '') {
		document.getElementById('errcode').innerHTML = " * Email field is Empty";
		document.getElementById('errcode').style.display = "block";
	} else if (!checkNumber(Number(document.getElementById('empCode').value)) ) {
		document.getElementById('errcode').innerHTML = " *Please Enter only Numbers:";
		document.getElementById('errcode').style.display = "block";
	} else {
